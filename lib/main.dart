      ...
      child: BlocBuilder<ThemeCubit, ThemeMode>(builder: (_, mode) {
        return MaterialApp(
          ...
          theme: ThemeData.light().copyWith(
            ...
            textTheme: TextTheme(
              headline1: aeonikRegularBlack,
              headline2: aeonikRegularBlack,
              headline3: aeonikRegularBlack,
              headline4: aeonikRegularBlack,
          ...
          darkTheme: ThemeData.dark().copyWith(
            ...
            textTheme: TextTheme(
              headline1: aeonikRegularWhite,
              headline2: aeonikRegularWhite,
              headline3: aeonikRegularWhite,
              headline4: aeonikRegularWhite,
