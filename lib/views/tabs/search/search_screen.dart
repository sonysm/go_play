            ...
            child: Column(
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(border: Border(bottom: BorderSide(width: 0.5, color: isLight(context) ?  Colors.black12 : Colors.white12))),
                  child: Row(
                    children: [
                      CupertinoButton(
                      ...
                      Expanded(
                        child: Container(
                          height: 44.0,
                          decoration: BoxDecoration(color: isLight(context) ? Colors.blueGrey[50] : Colors.blueGrey, borderRadius: BorderRadius.circular(50)),
                          child: TextField(
